//[=============================================================================================================]
//[ Source code for Quark star in f(R) = R + alpha R^2 + omega R T gravity.			      		]
//[														]
//[ The main purpose of the code is to identify the central value of Ricci scalar R_c corresponding to a given  ]	
//[ central density. 												]				
//														]
//[ Author: Arun Mathew, New Numerical Lab, Dept. of Physics, IIT Guwahati. Date:2019                     	]
//[=============================================================================================================]
...
/*  Interior field equations for the actual f(R,T) gravity. "A" stands for the actual quantities and 
...
/*  Exterior field equations for the actual f(R,T) gravity. "A" stands for the actual quantities and 
